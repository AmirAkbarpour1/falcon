...
export namespace Prisma {
  ...
  */
  ...
  export interface PanelDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
     ...
     * 
     * // Only select the `key`
     * const panelWithKeyOnly = await prisma.panel.findMany({ select: { key: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Panels and only return the `key`
     * const panelWithKeyOnly = await prisma.panel.createManyAndReturn({ 
     *   select: { key: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * 
     */
    createManyAndReturn<T extends PanelCreateManyAndReturnArgs>(args?: SelectSubset<T, PanelCreateManyAndReturnArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$PanelPayload<ExtArgs>, T, "createManyAndReturn">>
  ...
  interface PanelFieldRefs {
    readonly key: FieldRef<"Panel", 'String'>
    readonly host: FieldRef<"Panel", 'String'>
    readonly username: FieldRef<"Panel", 'String'>
    readonly password: FieldRef<"Panel", 'String'>
    readonly port: FieldRef<"Panel", 'String'>
    readonly path: FieldRef<"Panel", 'String'>
    readonly session: FieldRef<"Panel", 'String'>
    readonly subPort: FieldRef<"Panel", 'String'>
    readonly subPath: FieldRef<"Panel", 'String'>
    readonly enable: FieldRef<"Panel", 'Boolean'>
  }
  ...
  export interface ClientDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
     ...
     * 
     * // Only select the `key`
     * const clientWithKeyOnly = await prisma.client.findMany({ select: { key: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Clients and only return the `key`
     * const clientWithKeyOnly = await prisma.client.createManyAndReturn({ 
     *   select: { key: true },
     *   data: [
     *     // ... provide data here
     *   ]
  ...
  interface ClientFieldRefs {
    readonly key: FieldRef<"Client", 'String'>
    readonly email: FieldRef<"Client", 'String'>
    readonly uuid: FieldRef<"Client", 'String'>
    readonly enable: FieldRef<"Client", 'Boolean'>
    readonly limitIp: FieldRef<"Client", 'Int'>
    readonly ipsCount: FieldRef<"Client", 'Int'>
    readonly totalTraffic: FieldRef<"Client", 'String'>
    readonly download: FieldRef<"Client", 'String'>
    readonly upload: FieldRef<"Client", 'String'>
    readonly totalUsage: FieldRef<"Client", 'String'>
    readonly remainingTraffic: FieldRef<"Client", 'String'>
    readonly expirationDay: FieldRef<"Client", 'String'>
    readonly remainingTime: FieldRef<"Client", 'String'>
    readonly config: FieldRef<"Client", 'String'>
  }
  ...
  export type PanelWhereInput = {
    ...
    key?: StringFilter<"Panel"> | string
    host?: StringFilter<"Panel"> | string
    username?: StringFilter<"Panel"> | string
    password?: StringFilter<"Panel"> | string
    port?: StringFilter<"Panel"> | string
    path?: StringNullableFilter<"Panel"> | string | null
    session?: StringNullableFilter<"Panel"> | string | null
    subPort?: StringFilter<"Panel"> | string
    subPath?: StringNullableFilter<"Panel"> | string | null
    enable?: BoolNullableFilter<"Panel"> | boolean | null
  }
  ...
  export type PanelOrderByWithRelationInput = {
    ...
    subPort?: SortOrder
    subPath?: SortOrderInput | SortOrder
  ...
  export type PanelScalarWhereWithAggregatesInput = {
    ...
    key?: StringWithAggregatesFilter<"Panel"> | string
    host?: StringWithAggregatesFilter<"Panel"> | string
    username?: StringWithAggregatesFilter<"Panel"> | string
    password?: StringWithAggregatesFilter<"Panel"> | string
    port?: StringWithAggregatesFilter<"Panel"> | string
    path?: StringNullableWithAggregatesFilter<"Panel"> | string | null
    session?: StringNullableWithAggregatesFilter<"Panel"> | string | null
    subPort?: StringWithAggregatesFilter<"Panel"> | string
    subPath?: StringNullableWithAggregatesFilter<"Panel"> | string | null
    enable?: BoolNullableWithAggregatesFilter<"Panel"> | boolean | null
  }
  ...
  export type ClientWhereInput = {
    ...
    key?: StringFilter<"Client"> | string
    email?: StringFilter<"Client"> | string
    uuid?: StringFilter<"Client"> | string
    enable?: BoolFilter<"Client"> | boolean
    limitIp?: IntFilter<"Client"> | number
    ipsCount?: IntFilter<"Client"> | number
    totalTraffic?: StringFilter<"Client"> | string
    download?: StringFilter<"Client"> | string
    upload?: StringFilter<"Client"> | string
    totalUsage?: StringFilter<"Client"> | string
    remainingTraffic?: StringFilter<"Client"> | string
    expirationDay?: StringFilter<"Client"> | string
    remainingTime?: StringFilter<"Client"> | string
    config?: StringFilter<"Client"> | string
  }
  ...
  export type ClientOrderByWithRelationInput = {
    ...
    limitIp?: SortOrder
    ipsCount?: SortOrder
    totalTraffic?: SortOrder
    download?: SortOrder
    upload?: SortOrder
    totalUsage?: SortOrder
    remainingTraffic?: SortOrder
    expirationDay?: SortOrder
  ...
  export type ClientScalarWhereWithAggregatesInput = {
    ...
    key?: StringWithAggregatesFilter<"Client"> | string
    email?: StringWithAggregatesFilter<"Client"> | string
    uuid?: StringWithAggregatesFilter<"Client"> | string
    enable?: BoolWithAggregatesFilter<"Client"> | boolean
    limitIp?: IntWithAggregatesFilter<"Client"> | number
    ipsCount?: IntWithAggregatesFilter<"Client"> | number
    totalTraffic?: StringWithAggregatesFilter<"Client"> | string
    download?: StringWithAggregatesFilter<"Client"> | string
    upload?: StringWithAggregatesFilter<"Client"> | string
    totalUsage?: StringWithAggregatesFilter<"Client"> | string
    remainingTraffic?: StringWithAggregatesFilter<"Client"> | string
    expirationDay?: StringWithAggregatesFilter<"Client"> | string
    remainingTime?: StringWithAggregatesFilter<"Client"> | string
    config?: StringWithAggregatesFilter<"Client"> | string
  }
  ...
  export type PanelUpdateInput = {
    ...
    subPort?: StringFieldUpdateOperationsInput | string
    subPath?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type ClientUpdateInput = {
    ...
    limitIp?: IntFieldUpdateOperationsInput | number
    ipsCount?: IntFieldUpdateOperationsInput | number
    totalTraffic?: StringFieldUpdateOperationsInput | string
    download?: StringFieldUpdateOperationsInput | string
    upload?: StringFieldUpdateOperationsInput | string
    totalUsage?: StringFieldUpdateOperationsInput | string
    remainingTraffic?: StringFieldUpdateOperationsInput | string
    expirationDay?: StringFieldUpdateOperationsInput | string
    remainingTime?: StringFieldUpdateOperationsInput | string
